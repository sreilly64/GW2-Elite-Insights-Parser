...
namespace GW2EIEvtcParser.EIData
{
    public class Buff : IVersionable
    {
        ...
        internal static readonly List<Buff> FightSpecific = new List<Buff>
        {
                ...
                //Open World Soo-Won
                new Buff("Jade Tech Offensive Overcharge", JadeTechOffensiveOvercharge, Source.FightSpecific, BuffClassification.Offensive, "https://wiki.guildwars2.com/images/d/d2/Jade_Tech_Offensive_Overcharge.png"),
                new Buff("Jade Tech Defensive Overcharge", JadeTechDefensiveOvercharge, Source.FightSpecific, BuffClassification.Defensive, "https://wiki.guildwars2.com/images/4/4e/Jade_Tech_Defensive_Overcharge.png"),
