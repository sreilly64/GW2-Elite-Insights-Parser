...
namespace GW2EIEvtcParser.EIData
{
    public class Buff : IVersionable
    {
        ...
        internal static readonly List<Buff> FightSpecific = new List<Buff>
        {
                ...
                // Mai Trin
                new Buff("Shared Destruction (Mai Trin)", SharedDestructionMaiTrin, Source.FightSpecific, BuffClassification.Other, "https://wiki.guildwars2.com/images/6/65/Windfall.png" ),
                new Buff("Shared Destruction CM (Mai Trin)", SharedDestructionMaiTrinCM, Source.FightSpecific, BuffClassification.Other, "https://wiki.guildwars2.com/images/6/65/Windfall.png" ),
                ...
                new Buff("Exposed (Aetherblade Hideout)", ExposedAetherbladeHideout, Source.Common, BuffStackType.Stacking, 10, BuffClassification.Debuff, "https://wiki.guildwars2.com/images/6/6b/Exposed.png" ),
                ...
                new Buff("Stronger Together", StrongerTogether, Source.FightSpecific, BuffClassification.Other, "https://wiki.guildwars2.com/images/6/65/Windfall.png" ),
                new Buff("Vitality Equalizer 1", VitalityEqualizer1, Source.FightSpecific, BuffClassification.Other, "https://wiki.guildwars2.com/images/6/65/Windfall.png" ),
                new Buff("Vitality Equalizer 2", VitalityEqualizer2, Source.FightSpecific, BuffClassification.Other, "https://wiki.guildwars2.com/images/6/65/Windfall.png" ),
                new Buff("Destructive Aura", DestructiveAura, Source.FightSpecific, BuffStackType.StackingConditionalLoss, 10, BuffClassification.Other, "https://wiki.guildwars2.com/images/6/65/Windfall.png" ),
                new Buff("Equalization Matrix", EqualizationMatrix, Source.FightSpecific, BuffStackType.Stacking, 99, BuffClassification.Other, "https://wiki.guildwars2.com/images/6/65/Windfall.png" ),
                new Buff("Lethal Inspiration", LethalInspiration, Source.FightSpecific, BuffStackType.Stacking, 1, BuffClassification.Other, "https://wiki.guildwars2.com/images/6/65/Windfall.png" ),
                ...
                new Buff("Dragon's End Contributor 1", DragonsEndContributor1, Source.FightSpecific, BuffClassification.DragonsEndContributor, "https://wiki.guildwars2.com/images/a/ad/Seraph_Morale_01.png"),
                new Buff("Dragon's End Contributor 2", DragonsEndContributor2, Source.FightSpecific, BuffClassification.DragonsEndContributor, "https://wiki.guildwars2.com/images/6/6b/Seraph_Morale_02.png"),
                new Buff("Dragon's End Contributor 3", DragonsEndContributor3, Source.FightSpecific, BuffClassification.DragonsEndContributor, "https://wiki.guildwars2.com/images/3/30/Seraph_Morale_03.png"),
                new Buff("Dragon's End Contributor 4", DragonsEndContributor4, Source.FightSpecific, BuffClassification.DragonsEndContributor, "https://wiki.guildwars2.com/images/5/51/Seraph_Morale_04.png"),
                new Buff("Dragon's End Contributor 5", DragonsEndContributor5, Source.FightSpecific, BuffClassification.DragonsEndContributor, "https://wiki.guildwars2.com/images/9/90/Seraph_Morale_05.png"),
                new Buff("Dragon's End Contributor 6", DragonsEndContributor6, Source.FightSpecific, BuffClassification.DragonsEndContributor, "https://wiki.guildwars2.com/images/0/06/Seraph_Morale_06.png"),
                new Buff("Dragon's End Contributor 7", DragonsEndContributor7, Source.FightSpecific, BuffClassification.DragonsEndContributor, "https://wiki.guildwars2.com/images/1/1a/Seraph_Morale_07.png"),
                new Buff("Dragon's End Contributor 8", DragonsEndContributor8, Source.FightSpecific, BuffClassification.DragonsEndContributor, "https://wiki.guildwars2.com/images/0/0a/Seraph_Morale_08.png"),
                new Buff("Dragon's End Contributor 9", DragonsEndContributor9, Source.FightSpecific, BuffClassification.DragonsEndContributor, "https://wiki.guildwars2.com/images/9/9e/Seraph_Morale_09.png"),
                ...
                new Buff("Dragon's End Contributor", DragonsEndContributor, Source.FightSpecific, BuffStackType.Stacking, 10, BuffClassification.Support, "https://wiki.guildwars2.com/images/7/7b/Seraph_Morale_10.png"),
        };
